#!/usr/bin/env python3
"""interaction_kdj__ret5d_pos 因子分层回测脚本 (v2.48, 2026-06-24)
...
class InteractionKdjRet5dPosLayerConfig(LayerConfigBase):
    """interaction_kdj__ret5d_pos 分层配置
    ...
    factor_name: ClassVar[str] = "interaction_kdj__ret5d_pos"
...
if __name__ == "__main__":
    factor_cli_main(
        config_cls=InteractionKdjRet5dPosLayerConfig,
        factor_calculator=calculate_interaction_kdj__ret5d_pos,
    )
