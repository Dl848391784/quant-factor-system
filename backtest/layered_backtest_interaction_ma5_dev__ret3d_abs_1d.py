#!/usr/bin/env python3
"""interaction_ma5_dev__ret3d_abs 因子分层回测脚本 (v2.48, 2026-06-24)
...
class InteractionMa5DevRet3dAbsLayerConfig(LayerConfigBase):
    """interaction_ma5_dev__ret3d_abs 分层配置
    ...
    factor_name: ClassVar[str] = "interaction_ma5_dev__ret3d_abs"
...
if __name__ == "__main__":
    factor_cli_main(
        config_cls=InteractionMa5DevRet3dAbsLayerConfig,
        factor_calculator=calculate_interaction_ma5_dev__ret3d_abs,
    )
