#!/usr/bin/env python3
"""interaction_kdj__ret5d_abs 因子分层回测脚本 (v2.48, 2026-06-24)
...
class InteractionKdjRet5dAbsLayerConfig(LayerConfigBase):
    """interaction_kdj__ret5d_abs 分层配置
    ...
    factor_name: ClassVar[str] = "interaction_kdj__ret5d_abs"
...
if __name__ == "__main__":
    factor_cli_main(
        config_cls=InteractionKdjRet5dAbsLayerConfig,
        factor_calculator=calculate_interaction_kdj__ret5d_abs,
    )
