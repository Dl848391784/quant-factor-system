#!/usr/bin/env python3
"""interaction_amplitude__ret3d_neg 因子分层回测脚本 (v2.48, 2026-06-24)
...
class InteractionAmplitudeRet3dNegLayerConfig(LayerConfigBase):
    """interaction_amplitude__ret3d_neg 分层配置
    ...
    factor_name: ClassVar[str] = "interaction_amplitude__ret3d_neg"
...
if __name__ == "__main__":
    factor_cli_main(
        config_cls=InteractionAmplitudeRet3dNegLayerConfig,
        factor_calculator=calculate_interaction_amplitude__ret3d_neg,
    )
