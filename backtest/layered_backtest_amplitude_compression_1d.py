...
class AmplitudeCompressionBacktest(LayeredBacktestConfig):
    """振幅收敛因子分层回测配置（遵循 M5 ClassVar 薄声明）"""

    factor_name: str = "amplitude_compression"
    factor_col: str = "amplitude_compression"
    period: str = "1d"
...
def main() -> None:
    factor_cli_main(AmplitudeCompressionBacktest)
