#!/usr/bin/env python3
"""interaction_bollinger__ret5d_pos 因子分层回测脚本 (v2.48, 2026-06-24)
...
class InteractionBollingerRet5dPosLayerConfig(LayerConfigBase):
    """interaction_bollinger__ret5d_pos 分层配置
    ...
    factor_name: ClassVar[str] = "interaction_bollinger__ret5d_pos"
...
if __name__ == "__main__":
    factor_cli_main(
        config_cls=InteractionBollingerRet5dPosLayerConfig,
        factor_calculator=calculate_interaction_bollinger__ret5d_pos,
    )
