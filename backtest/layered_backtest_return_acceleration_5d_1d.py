...
class ReturnAcceleration5dBacktest(LayeredBacktestConfig):
    """收益率加速度因子分层回测配置（遵循 M5 ClassVar 薄声明）"""

    factor_name: str = "return_acceleration_5d"
    factor_col: str = "return_acceleration_5d"
    period: str = "1d"
...
def main() -> None:
    factor_cli_main(ReturnAcceleration5dBacktest)
