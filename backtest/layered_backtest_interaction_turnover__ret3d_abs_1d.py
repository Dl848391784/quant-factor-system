#!/usr/bin/env python3
"""interaction_turnover__ret3d_abs 因子分层回测脚本 (v2.48, 2026-06-24)
...
class InteractionTurnoverRet3dAbsLayerConfig(LayerConfigBase):
    """interaction_turnover__ret3d_abs 分层配置
    ...
    factor_name: ClassVar[str] = "interaction_turnover__ret3d_abs"
...
if __name__ == "__main__":
    factor_cli_main(
        config_cls=InteractionTurnoverRet3dAbsLayerConfig,
        factor_calculator=calculate_interaction_turnover__ret3d_abs,
    )
