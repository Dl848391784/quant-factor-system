#!/usr/bin/env python3
"""interaction_price_pos__ret1d_neg 因子分层回测脚本 (v2.48, 2026-06-24)
...
class InteractionPricePosRet1dNegLayerConfig(LayerConfigBase):
    """interaction_price_pos__ret1d_neg 分层配置
    ...
    factor_name: ClassVar[str] = "interaction_price_pos__ret1d_neg"
...
if __name__ == "__main__":
    factor_cli_main(
        config_cls=InteractionPricePosRet1dNegLayerConfig,
        factor_calculator=calculate_interaction_price_pos__ret1d_neg,
    )
