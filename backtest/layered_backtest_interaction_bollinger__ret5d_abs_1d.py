#!/usr/bin/env python3
"""interaction_bollinger__ret5d_abs 因子分层回测脚本 (v2.48, 2026-06-24)
...
class InteractionBollingerRet5dAbsLayerConfig(LayerConfigBase):
    """interaction_bollinger__ret5d_abs 分层配置
    ...
    factor_name: ClassVar[str] = "interaction_bollinger__ret5d_abs"
...
if __name__ == "__main__":
    factor_cli_main(
        config_cls=InteractionBollingerRet5dAbsLayerConfig,
        factor_calculator=calculate_interaction_bollinger__ret5d_abs,
    )
