#!/usr/bin/env python3
"""interaction_near_high__ret3d_abs 因子分层回测脚本 (v2.48, 2026-06-24)
...
class InteractionNearHighRet3dAbsLayerConfig(LayerConfigBase):
    """interaction_near_high__ret3d_abs 分层配置
    ...
    factor_name: ClassVar[str] = "interaction_near_high__ret3d_abs"
...
if __name__ == "__main__":
    factor_cli_main(
        config_cls=InteractionNearHighRet3dAbsLayerConfig,
        factor_calculator=calculate_interaction_near_high__ret3d_abs,
    )
