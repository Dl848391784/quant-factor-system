...
echo "  - 日志文件: /home/admin/.openclaw/workspace/yunzhou/factor_ic_analyzer/logs/optimizer.log"
echo ""
echo "常用命令:"
echo "  # 查看定时器状态"
...
echo ""
echo "  # 查看计算日志"
echo "  tail -f /home/admin/.openclaw/workspace/yunzhou/factor_ic_analyzer/logs/optimizer.log"
echo ""
echo "  # 停止定时器"
