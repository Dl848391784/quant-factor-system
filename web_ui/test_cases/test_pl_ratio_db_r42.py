"""v0.4.8 R42 v2 单元测试: load_pl_ratio_trend() 在真实 parquet 上跑通.

§18.1f v1.5.11 实战锚点: 改算法 + 改数据源后, 必须用真实 parquet 跑一次
...
def test_load_pl_ratio_trend_runs_on_real_parquet():
    """R42 v2 主路径: 真实 parquet 上能跑通, 返回结构符合契约."""
    ...
    assert result["source"] == "summary_segment_stock_details"
