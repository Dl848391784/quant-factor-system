...
SPEC = register_factor(
    FactorSpec(
        ...
        required_columns=JOIN_KEYS + ("tail_volume_shrink", "tail_volume_shrink_delta"),
        calculation=calculate_tail_volume_shrink_delta,
    )
)
...
def main():
    ...
    log_factor_summary(result, "尾盘缩量差分因子", logger)
