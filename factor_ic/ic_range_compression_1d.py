...
- 因子计算逻辑复用 data_fetchers.factor_calculator 的 calculate_range_compression

因子定义：
- range_compression: (rolling_high_5d - rolling_low_5d) / (rolling_high_10d - rolling_low_10d)
- 含义: 近期价格波动范围相对历史变化，<1=波动范围收敛
...
def main(args=None):  # noqa: C901
    ...
    log_factor_summary(result, factor_name="range_compression")
    sys.exit(0)
