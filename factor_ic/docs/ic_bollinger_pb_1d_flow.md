...
> 生成时间: 2026-05-20 00:20 (北京时间)
> 实测数据时间: 2026-05-20 00:20 (北京时间)
> 审阅版本: v2.7
> 更新内容:
>   ...
...
| v2.7 | 2026-05-20 | 修复 %B 计算浮点数除零判断（diff==0 → np.abs(diff)<1e-10）+ 补充 MODULE.md 浮点数等值比较规范 |
| v2.6 | 2026-05-20 | 修复布林带标准差 ddof 参数（ddof=1 → ddof=0）+ 补充 MODULE.md 布林带标准差 ddof 参数规范 |

---

*最后更新: 2026-05-20 00:20:00 (北京时间)*