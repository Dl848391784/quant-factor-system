#!/usr/bin/env python3
"""test_ic_capital_flow_intensity_1d 测试用例

测试脚本: factor_ic/ic_capital_flow_intensity_1d.py
因子计算: data_fetchers/factor_calculator.py::calculate_capital_flow_intensity
规范文档: factor_ic/MODULE.md

运行: pytest factor_ic/test_cases/test_ic_capital_flow_intensity_1d.py -v
"""
...
class TestOutputPath:
    ...
    def test_output_path_format(self):
        ...
        path = get_ic_output_path("capital_flow_intensity")
        assert path.name == "ic_capital_flow_intensity_analysis_result.json"
...
class TestOutputStructure:
    ...
    def test_output_file_exists_after_run(self):
        ...
        path = get_ic_output_path("capital_flow_intensity")
        if not path.exists():
            pytest.skip("输出文件不存在，需要先运行 ic_capital_flow_intensity_1d.py")
