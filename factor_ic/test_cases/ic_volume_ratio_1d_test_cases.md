...
> 实测数据时间: 2026-05-23 22:55（验证输出结构符合MODULE.md规范）
...
>      - 异常处理测试更新：分开处理多种异常类型
>   5. v1.9 CLI参数解析同步（2026-05-23 22:55）：
>      - TC001预期日志更新：添加 [2/4] 步骤日志
>      - 新增 TC007：CLI 参数测试（--force-full、--output、--min-stocks）
>      - 验证结果摘要格式更新：因子名称、更新模式字段
