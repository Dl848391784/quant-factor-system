#!/usr/bin/env python3
"""test_ic_industry_roe_trend_1d 测试用例

测试脚本: factor_ic/ic_industry_roe_trend_1d.py
因子计算: data_fetchers/factor_calculator.py::calculate_industry_roe_trend
规范文档: factor_ic/MODULE.md

运行: pytest factor_ic/test_cases/test_ic_industry_roe_trend_1d.py -v
"""
...
class TestOutputPath:
    ...
    def test_output_path_format(self):
        ...
        path = get_ic_output_path("industry_roe_trend")
        assert path.name == "ic_industry_roe_trend_analysis_result.json"
...
class TestOutputStructure:
    ...
    def test_output_file_exists_after_run(self):
        ...
        path = get_ic_output_path("industry_roe_trend")
        if not path.exists():
            pytest.skip("输出文件不存在，需要先运行 ic_industry_roe_trend_1d.py")
